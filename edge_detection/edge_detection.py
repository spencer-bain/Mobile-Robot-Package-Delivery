...
def do_segment(frame):
    ...
    # frame.shape[0] give us the number of rows of pixels the frame has. Since height begins from 0 at the top,
...
def calculate_lines(frame, lines):
    ...
    for line in lines:
        ...
        # Fits a linear polynomial to the x and y coordinates and returns a vector of
        # coefficients which describe the slope and y-intercept
...
result = cv.VideoWriter('edges_output.avi',
